...
function setupLanguageSwitcher() {
    ...
    const translations = {
        en: {
            ...
            project1: "A brief description of Project 1.",
            project2: "A brief description of Project 2.",
            project3: "A brief description of Project 3.",
        ...
        es: {
            ...
            project1: "Una breve descripción del Proyecto 1.",
            project2: "Una breve descripción del Proyecto 2.",
            project3: "Una breve descripción del Proyecto 3.",
